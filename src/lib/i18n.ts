...
const translations = {
  en: {
    ...
    "celebration.roundComplete": "Nice!",
    "celebration.nextRound": "Next Round",
  ...
  "pt-BR": {
    ...
    "celebration.roundComplete": "Muito bem!",
    "celebration.nextRound": "Próxima Rodada",
    ...
    "settings.difficulty.beginner": "Iniciante",
    "settings.difficulty.intermediate": "Intermediário",
    "settings.difficulty.advanced": "Avançado",
    "settings.color": "Cor",
